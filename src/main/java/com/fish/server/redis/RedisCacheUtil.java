...
public class RedisCacheUtil<T> {
	...
	public <T> ValueOperations<String, T> setCacheObject(String key, T value) {
		...
		setExpire(key, Integer.MAX_VALUE);
		return operation;
	}
	...
	public <T> ListOperations<String, T> setCacheList(String key, List<T> dataList) {
		...
		boolean flag = setExpire(key, Integer.MAX_VALUE);
	...
	public Boolean setExpire(String key, int sec) {
		// TODO Auto-generated method stub
		return redisTemplate.expire(key, sec, TimeUnit.SECONDS);
	}

	public List getCacheObjectList(String key) {
