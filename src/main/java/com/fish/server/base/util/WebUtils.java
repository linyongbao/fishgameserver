...
public class WebUtils {
	...
	private static Agent[] browsers = new Agent[] {
			...
			new Agent("(Symphony) (\\d+).(\\d+)", null, null, null), new Agent("(Minimo)", null, null, null),
			...
			new Agent(
					...
					null, null, null),
			new Agent(
					"(Bolt|Jasmine|IceCat|Skyfire|Midori|Maxthon|Lynx|Arora|IBrowse|Dillo|Camino|Shiira|Fennec|Phoenix|Chrome|Flock|Netscape|Lunascape|Epiphany|WebPilot|Opera Mini|Opera|Vodafone|NetFront|Netfront|Konqueror|Googlebot|SeaMonkey|Kazehakase|Vienna|Iceape|Iceweasel|IceWeasel|Iron|K-Meleon|Sleipnir|Galeon|GranParadiso|iCab|NetNewsWire|Space Bison|Stainless|Orca|Dolfin|BOLT|Minimo|Tizen Browser|Polaris|Abrowser)/(\\d+)\\.(\\d+)",
					null, null, null),
			new Agent("(iRider|Crazy Browser|SkipStone|iCab|Lunascape|Sleipnir|Maemo Browser) (\\d+)\\.(\\d+)\\.(\\d+)",
					null, null, null),
			new Agent("(iCab|Lunascape|Opera|Android|Jasmine|Polaris|BREW) (\\d+)\\.(\\d+)\\.?(\\d+)?", null, null,
					null),
			new Agent("(Android) Donut", "2", "1", null), new Agent("(Android) Eclair", "1", "2", null),
			new Agent("(Android) Froyo", "2", "2", null), new Agent("(Android) Gingerbread", "3", "2", null),
			...
			new Agent("(Obigo)InternetBrowser", null, null, null), new Agent("(Obigo)\\-Browser", null, null, null),
			...
			new Agent("(AvantGo) (\\d+).(\\d+)", null, null, null), new Agent("(Avant)", null, "1", null),
			...
			new Agent("(Safari)/\\d+", null, null, null), new Agent("(OLPC)/Update(\\d+)\\.(\\d+)", null, null, null),
			new Agent("(OLPC)/Update()\\.(\\d+)", null, "0", null),
			new Agent("(SEMC\\-Browser)/(\\d+)\\.(\\d+)", null, null, null),
			new Agent("(Teleca)", null, null, "Teleca Browser"), new Agent("(MSIE) (\\d+)\\.(\\d+)", null, null, "IE"),
	...
	private static Agent[] os = new Agent[] {
			...
			new Agent("(Android)\\-(\\d+)\\.(\\d+)(?:[.\\-]([a-z0-9]+))?", null, null, null),
			new Agent("(Android) Donut", "1", "2", null), new Agent("(Android) Eclair", "2", "1", null),
			new Agent("(Android) Froyo", "2", "2", null), new Agent("(Android) Gingerbread", "2", "3", null),
			new Agent("(Android) Honeycomb", "3", null, null), new Agent("(Windows Phone 6\\.5)", null, null, null),
			...
			new Agent("(WinNT4.0)", null, null, "Windows NT 4.0"), new Agent("(Win98)", null, null, "Windows 98"),
			...
			new Agent("(Series 60|SymbOS|S60)", null, null, "Symbian OS"), new Agent("(MeeGo)", null, null, null),
			...
			new Agent("(Windows|OpenBSD|FreeBSD|NetBSD|Ubuntu|Kubuntu|Android|Arch Linux|CentOS|WeTab|Slackware)", null,
					null, null),
